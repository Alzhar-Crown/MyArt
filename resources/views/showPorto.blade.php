...
@section('main')
    <div class="h-[100vh] w-fit justify-between mx-auto">
        ...
        <div id="container" class="cont w-[90%] mx-auto  h-[80%]    flex flex-row gap-3  p-2 ">
                    ...
                    <div class="flex flex-row gap-2">
                        ...
                        @if(!in_array($porto->id, $liked))
                            <form action="{{ route('love', ['love' => $porto->id]) }}" class="mt-0" method="POST">
                                @csrf
                                <button type="submit"> <span class="material-symbols-outlined !text-[30px]  text-black">
                                        favorite </span>
                                </button>
                            </form>
            ...
            <a class="text text-black " href="{{ route('porto.index') }}"><span class="material-symbols-outlined"> close
                </span></a>
        </div>
